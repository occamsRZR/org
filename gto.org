...
*** TODO [#B] Move current event destinations's addresses into the event model
*** TODO [#A] Refactor front-end info box displaying of the data
    1. City-wide
...
*** TODO [#A] Duplicate address/geolocation of destination into the event
    1. City-wide
    2. Dest-tied
    3. Only Address
